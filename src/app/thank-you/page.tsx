      ...
      <Card className="w-full max-w-lg text-center shadow-xl">
        ...
        <CardContent>
          <p className="mb-4 text-muted-foreground">
            আপনার রক্তের অনুরোধটি সফলভাবে আমাদের প্ল্যাটফর্মে যুক্ত করা হয়েছে। প্রয়োজনে, আমাদের টিম আপনার দেওয়া নম্বরে যোগাযোগ করে রক্ত ব্যবস্থাপনায় আপনাকে সাহায্য করতে পারে।
          </p>
          <p className="mb-6">
