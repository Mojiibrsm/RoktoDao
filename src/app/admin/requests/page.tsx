...
const RequestForm = ({ form, onSubmit, isSubmitting, submitText }: RequestFormProps) => {
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <Dialog open={isAddDialogOpen} onOpenChange={(isOpen) => {
                        ...
                        <DialogContent className="sm:max-w-[625px]">
                          ...
                          <RequestForm form={form} onSubmit={handleAddRequest} isSubmitting={form.formState.isSubmitting} submitText="Add Request" />
                        </DialogContent>
                      </Dialog>
                  </div>
                </CardHeader>
